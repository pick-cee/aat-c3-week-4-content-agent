...
import { canApprove } from "@/lib/db/client";
  ...
  return (
    <>
      ...
      <div className="stack">
        ...
        {/* ── The newsletter list ── */}
        <section className="section">
          <RecipientsManager recipients={recipients} canEdit={canApprove(profile)} />
        </section>

        {/* ── Brand voice ── */}
        {voices.map((voice) => (
          <section key={voice.id} className="section">
            <BrandVoiceEditor voice={voice} />
          </section>
        ))}
        ...
        <section className="section">
          <div className="section-head">
            <h2 className="section-title">Spend, last 30 days</h2>
