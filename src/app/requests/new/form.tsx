...
export function NewRequestForm({
  ...
  const [budget, setBudget] = useState(String(defaultBudgetCents));
  ...
  const budgetCents = Number.parseInt(budget, 10) || 0;
      ...
      <div className="card card-pad">
        ...
        <div className="field-row">
          ...
          <div className="field">
            ...
            />
            <div className="hint">
              {isDemo ? "Capped for the demo workspace." : "Crossing it stops the request, intact."}
            </div>
          </div>
        </div>
